...
<head>
    ...
    <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5e927a3f6ed0db64"></script>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @if(Auth::check())
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('photos.index') }}">Manage Wallpapers</a>
                            </li>
                        @endif
                        <!-- Authentication Links -->
                        @guest
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('login') }}">{{ __('Login (Admin Only)')}}</a>
                            </li>
